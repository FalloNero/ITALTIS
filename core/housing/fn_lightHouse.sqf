...
if(!((_house isKindOf "House_F")OR(_house isKindOf "House_F"))) exitWith {};
_exit = false;
if(_mode) then {
	...
	switch(true) do {
		...
		//AGGIUNGERE
		//"Land_e76_us_house01","Land_e76_us_house01a","Land_e76_us_house01b","Land_e76_us_house02","Land_e76_us_house02a","Land_e76_us_house03"
		default {_exit = true;};
	};
