...
if((life_trunk_vehicle isKindOf "House_F")OR(life_trunk_vehicle isKindOf "House_EP1")) then {
	_mWeight = 0;
...
if(_ctrl == "goldbar" && {!(life_trunk_vehicle isKindOf "LandVehicle" OR life_trunk_vehicle isKindOf "House_F" OR life_trunk_vehicle isKindOf "House_EP1")}) exitWith {hint "You cannot store that in anything but a land vehicle!"};
