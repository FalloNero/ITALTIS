...
if(!((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship") || (_vehicle isKindOf "Motorcycle"))) exitWith {};
if(player distance cursorTarget > 10) exitWith {};
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship") || (_vehicle isKindOf "Motorcycle")) then
{
	_vehicleData = _vehicle getVariable["vehicle_info_owners",[]];
	if(count _vehicleData == 0) exitWith {}; //Bad vehicle. deleteVehicle _vehicle
	...
	{
		if(!((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship") || (_vehicle isKindOf "Motorcycle"))) exitWith {life_action_inUse = false;};
		...
		[[0,format[localize "STR_NOTF_HasImpounded",(_vehicleData select 0) select 1,profileName,_vehicleName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
