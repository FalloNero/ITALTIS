...
if(((_door select 0) == "0")OR((_door select 0) == "maindoorl")) exitWith {hint "Avvicinati ad una cella"};
...
fed_jail animate [_door select 0,0];
[[_unit,false,_door select 1],"life_fnc_jail",_unit,false] spawn life_fnc_MP;
