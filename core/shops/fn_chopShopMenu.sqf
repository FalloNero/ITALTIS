...
if(license_civ_meccanico) exitWith {hint localize "Stai facendo il furbetto??"; [[player getVariable["realname",name player],format["Variable: %1","MECCANICO CHE VENDE MEZZO AL RICETTATORE..."]],"SPY_fnc_notifyAdmins",true,false] spawn life_fnc_MP;};
disableSerialization;
private["_nearVehicles","_control"];
_nearVehicles = nearestObjects [getMarkerPos (_this select 3),["Car","Truck","Motorcycle","Air"],25];
