	...
	case "cop_basic":
	{
		switch(true) do
		{
			...
			_weap = ["Negozio Poliziotti",
				...
				{
					_app = _weap select 1;
					_app pushBack["arifle_MXM_Black_F","MXM Nero",150000];
		...
		switch(true) do
		{
			...
			_weap = ["Negozio mafia",
					[
						...
						["hgun_Pistol_heavy_02_F","Revolver Zubr .45ACP",100000],
						...
						["acc_flashlight","Torcia per fucili",500],
						["acc_pointer_IR","Puntatore Infrarosso per fucili",500],
						["SMG_02_F","STING 9mm",140000],
						["30Rnd_9x21_Mag","STING Munizioni", 400],
						["arifle_TRG21_F","AssaultRifle TRG 21 5.56mm",200000],
						["30Rnd_556x45_Stanag","Caricatore 30Rnd TRG20/21",1000],
						["arifle_Katiba_F","AssaultRifle Katiba 6.5mm",250000],
		...
		switch(true) do
		{
			...
			_weap = ["Negozio Armi",
					[
						...
						["hgun_Pistol_heavy_02_F","Revolver Zubr .45ACP",100000],
						["6Rnd_45ACP_Cylinder","Caricatore 6Rnd Zubr",200],
						["hgun_ACPC2_F","ACP C2 .45ACP",120000],
						["9Rnd_45ACP_Mag","Caricatore 9Rnd ACP C2",250],
						["hgun_PDW2000_F","Mitra PDW 9mm",240000],
        ...
        switch(true) do
        {
            ...
            default
            {
                _weap =["Armamento Covo",
                    [
						["hgun_PDW2000_F","Mitraglietta PDW",200000],
						["30Rnd_9x21_Mag","PDW Munizioni",500],
						["hgun_Pistol_heavy_02_F","Pistola ZUBR",80000],
						["6Rnd_45ACP_Cylinder","ZUBR Munizioni",500],
						["arifle_SDAR_F","SDAR Rifle",300000],
						["30Rnd_556x45_Stanag","SDAR Mag",3000],
						["SMG_02_F","STING 9mm",300000],
						["30Rnd_9x21_Mag","STING Munizioni", 4000],
						["arifle_TRG21_F","AssaultRifle TRG 21 5.56mm",350000],
						["30Rnd_556x45_Stanag","Caricatore 30Rnd TRG20/21",5000],
						["optic_Holosight","Ottica Holo 1x",10000]				
                    ]
                ];
            };
        };
