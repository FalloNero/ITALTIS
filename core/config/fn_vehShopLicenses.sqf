...
switch (life_veh_shop select 0) do
{
	...
	case "mec_car": {_ret = license_civ_truck;};
	case "med_air_hs": {_ret = license_med_air;};
	case "civ_car": {_ret = license_civ_driver;};
    case "bike_shop": {_ret = license_civ_driver;};
	...
	case "merc_gar1_s": {_ret = license_civ_merc;};
	case "merc_h_sho_s": {_ret = license_civ_merc;};
	case "mafia_h_sho_s": {_ret = license_civ_mafia;};
	case "mafia_gar1_s": {_ret = license_civ_mafia;};
	case "SOA_GAR_SP": {_ret = license_civ_soa;};
	case "SOA_HELI_SP": {_ret = license_civ_soa;};
	case "sha": {_ret = life_shadow;};
	case "aod_h_sho_s": {_ret = license_civ_autista;};
	case "aod_gar1_s": {_ret = license_civ_autista;};
	case "spartan_air": {_ret = license_civ_air;};
	case "spartan_gar": {_ret = license_civ_driver;};
	case "mafia_air": {_ret = license_civ_air;};
	case "mafia_gar": {_ret = license_civ_driver;};
