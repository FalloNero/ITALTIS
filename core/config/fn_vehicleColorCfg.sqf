...
switch (_vehicle) do
{
	case "I_Heli_Transport_02_F":
	{
		...
		_ret =
		[
			["texture\cop_CH49_1.jpg","cop","texture\cop_CH49_2.jpg","texture\cop_CH49_3.jpg"],
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["texture\police_offroad.jpg","cop"],
			["#(ai,64,64,1)Fresnel(1.3,7)","cop"],
			["#(argb,8,8,3)color(0.6,0.3,0.01,1)","civ"],
			["texture\ems_offroad.jpg","med"],
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["texture\police_suv.jpg","cop"],
			["\a3\soft_f_gamma\SUV_01\Data\suv_01_ext_03_co.paa","civ"],
			["\a3\soft_f_gamma\SUV_01\Data\suv_01_ext_04_co.paa","civ"],
			["#(ai,64,64,1)Fresnel(1.3,7)","cop"],
			["texture\ems_suv.jpg","med"],
			["texture\mafia_suv.jpg","mafia"],
	...
	case "B_Heli_Light_01_F":
	{
		_ret = 
		[
			["texture\police_hummingbird.jpg","cop"],
	...
	case "O_Heli_Attack_02_black_F":
	{
		_ret = 
		[
			["#(argb,8,8,3)color(0.05,0.05,0.05,1)","copd"]
		];
	};
	...
	case "B_Heli_Transport_01_F":
	{
		_ret = 
		[
			["texture\police_ghosthawk.jpg","cop"]
		];
	};
