...
private["_handle","_timeStamp","_hasLicense"];
...
switch (playerSide) do
{
	case west:
	{
		...
		if (license_cop_copamericano) then {
	...
	case east:
 	{
		...
		//Initialize Opfor
		if (license_cop_copmessico) then {
...
life_joinTime = time ;		//ORARIO DI INGRESSO NEL SERVER

//[] call life_fnc_loadkey;
[] spawn life_fnc_autoSave;
[] spawn life_fnc_resetFatigue;